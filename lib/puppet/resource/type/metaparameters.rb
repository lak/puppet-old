...
class Puppet::Resource::Type::RelationshipMetaparam < Puppet::Parameter
  class << self
...
Puppet::Resource::Type.newmetaparam(:noop) do
...
Puppet::Resource::Type.newmetaparam(:schedule) do
...
Puppet::Resource::Type.newmetaparam(:audit) do
...
Puppet::Resource::Type.newmetaparam(:check) do
...
Puppet::Resource::Type.newmetaparam(:loglevel) do
...
Puppet::Resource::Type.newmetaparam(:alias) do
...
Puppet::Resource::Type.newmetaparam(:tag) do
...
Puppet::Resource::Type.newmetaparam(:require, :parent => Puppet::Resource::Type::RelationshipMetaparam, :attributes => {:direction => :in, :events => :NONE}) do
...
Puppet::Resource::Type.newmetaparam(:subscribe, :parent => Puppet::Resource::Type::RelationshipMetaparam, :attributes => {:direction => :in, :events => :ALL_EVENTS, :callback => :refresh}) do
...
Puppet::Resource::Type.newmetaparam(:before, :parent => Puppet::Resource::Type::RelationshipMetaparam, :attributes => {:direction => :out, :events => :NONE}) do
...
Puppet::Resource::Type.newmetaparam(:notify, :parent => Puppet::Resource::Type::RelationshipMetaparam, :attributes => {:direction => :out, :events => :ALL_EVENTS, :callback => :refresh}) do
  desc %{References to one or more objects that depend on this object. This
...
Puppet::Resource::Type.newmetaparam(:stage) do
